...
export const DailyActivityLevel = [
...
export const Skill = [
  ...
  { value: "weight_loss", label: "Weight Loss Coaching" },
  ...
  { value: "rehabilitation", label: "Rehabilitation / Injury Recovery" },
  { value: "sports_training", label: "Sports-Specific Training" },
