import { Home, Clock, Briefcase, CheckCircle, MessageCircle, Dumbbell, LogOut } from "lucide-react"
  ...
  return (
    <div className="gym-sidebar">
      ...
      <div className="menu-container">
        {menuItems.map((item, idx) => (
          <button
            ...
            className={`menu-item ${activeItem === idx ? "active" : ""} ${hoveredItem === idx ? "hovered" : ""}`}
            title={item.label}
          >
            ...
            {hoveredItem === idx && <div className="tooltip">{item.label}</div>}
          </button>
        ))}
      </div>
      ...
      >
        ...
        {hoveredItem === "logout" && <div className="tooltip logout-tooltip">Logout</div>}
      </button>
    </div>
  )
}
