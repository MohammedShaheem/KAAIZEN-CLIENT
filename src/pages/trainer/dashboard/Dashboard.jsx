...
import TrainerLeaveModal from '@/components/trainer/modal/TrainerLeaveModal';
...
export default function Dashboard() {
  ...
  const { data: leaves } = useTrainerLeaves();
          ...
          <div className="flex-1 p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div 
                  className="bg-white p-6 rounded-xl border cursor-pointer hover:shadow-md transition-shadow"
                ...
                >
                  ...
                  <p className="text-lg font-bold text-purple-600">Apply Leave</p>
                  <p className="text-xs text-slate-400 mt-1">Request time off</p>
                </div>
              </div>
            </div>
          </div>
